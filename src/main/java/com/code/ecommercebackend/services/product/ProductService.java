...
public interface ProductService extends BaseService<Product, String> {
    ...
    ProductResponse findByUrl(String url) throws DataNotFoundException;
    AttributeResponse findAttributeByProductId(String productId) throws DataNotFoundException;
}
